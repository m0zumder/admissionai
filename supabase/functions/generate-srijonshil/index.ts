...
শুধু বাংলায় লেখো। Board পরীক্ষার ভাষা ও style follow করো।`;
    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        tools: [
          {
            type: "function",
            function: {
              name: "generate_srijonshil",
              description: "Generate structured creative answer with ka, kha, ga, gha sections",
              parameters: {
                type: "object",
                properties: {
        ...
        tool_choice: { type: "function", function: { name: "generate_srijonshil" } },
      }),
    });
