          ...
          <CardHeader>
            <div className="flex justify-center gap-2 mb-4">
              {Array.from({ length: totalSteps }, (_, i) => (
                <div key={i} className={`h-2 w-12 rounded-full transition-colors ${i + 1 <= onboardingStep ? 'bg-primary' : 'bg-muted'}`} />
              ))}
            </div>
          ...
          <CardContent className="space-y-4">
              ...
              <>
                <div className="grid grid-cols-2 gap-3">
                  {EXAM_OPTIONS.map((exam) => (
                    <button key={exam.id} onClick={() => { setTargetExam(exam.id); setHscStream(''); }}
                ...
                <div className="flex gap-3">
                  ...
                  <Button className="flex-1" onClick={() => {
                    if (!targetExam) { toast({ title: 'পরীক্ষা নির্বাচন করো', variant: 'destructive' }); return; }
                    setOnboardingStep(3);
                  }}>
                    পরবর্তী →
                  </Button>
            ...
            {currentContent === 'stream' && (
              <>
                ...
                <div className="grid grid-cols-1 gap-3">
                  {HSC_STREAMS.map((s) => (
                    <button key={s.id} onClick={() => setHscStream(s.id)}
                ...
                <div className="flex gap-3">
                  ...
                  <Button className="flex-1" onClick={() => {
                    if (!hscStream) { toast({ title: 'বিভাগ নির্বাচন করো', variant: 'destructive' }); return; }
                    setOnboardingStep(4);
                  }}>
                    পরবর্তী →
                  </Button>
            ...
            {currentContent === 3 && (
              <>
                ...
                <div className="flex gap-3">
                  <Button variant="outline" onClick={() => setOnboardingStep(isHSC ? 3 : 2)}>← আগে</Button>
            ...
            {currentContent === 4 && (
              <>
                ...
                <div className="flex gap-3">
                  <Button variant="outline" onClick={() => setOnboardingStep(isHSC ? 4 : 3)}>← আগে</Button>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          ...
          <p className="text-center text-xs text-muted-foreground mt-3">কোনো ফোন নম্বর দেওয়া লাগবে না 🔒</p>
